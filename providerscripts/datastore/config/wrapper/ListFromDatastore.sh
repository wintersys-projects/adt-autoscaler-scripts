...
# Author: Peter Winter
# Date :  9/4/2016
# Description: This abstracts the listing of a file so that ultimate implementation is 
...
then
        ...
        then
                /bin/echo "`/bin/ls -Art /var/lib/adt-config/STATIC_SCALE* | /bin/grep -v 'delete_me' | /usr/bin/tail -n 1 | /bin/sed 's:/var/lib/adt-config/::g'`"
