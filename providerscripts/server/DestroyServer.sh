...
then
	...
	then
		...
		${HOME}/providerscripts/datastore/config/wrapper/DeleteFromDatastore.sh "config"  "webserverips/${private_server_ip}"
		${HOME}/providerscripts/datastore/config/wrapper/DeleteFromDatastore.sh "config"  "webserverpublicips/${server_ip}"
		${HOME}/providerscripts/datastore/config/wrapper/DeleteFromDatastore.sh "config"  "beenonline/${server_ip}"
		${HOME}/providerscripts/datastore/config/wrapper/DeleteFromDatastore.sh "config"  "beingbuiltips/${private_server_ip}"
